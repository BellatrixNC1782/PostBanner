            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                            ...
                            <div class="wideget-user-tab">
                                <div class="tab-menu-heading p-0">
                                    <div class="tabs-menu1 px-3 border-top">
                                        <ul class="nav">
                                            <li><a href="{{route('purchasevideoreport')}}" class="active fs-14">Purchase Video Report</a></li>
                                            <li><a href="{{route('subscriptionreport')}}" class="fs-14">Subscription Report</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <table id="purchase_datatable" class="table table-bordered text-nowrap w-100">
                                <thead>
                                    <tr>
                                        <th>Sr. No.</th>
                                        <th>Email</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = jQuery('#purchase_datatable').DataTable({
            dom: 'Bfrtip',
            buttons: [{
                extend: 'excel',
                action: newexportaction,
                title: 'Anjana Yoga - Purchase Video Report',
                text: 'EXCEL',
            }, ],
            "processing": true,
            "serverSide": true,
            ...
            "ajax": {
                url: "<?php echo route('getpurchasevideoreport'); ?>",
                type: "GET",
                data: function(d) {
