        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" id="serviceaddform" name="profile_form" action="{{route('saveservice')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" value="" placeholder="Please Enter Service Name" />
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        <label class="form-label" for="detail_title">Service Detail Title<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="detail_title" name="detail_title" value="" placeholder="Please Enter Service Detail Title" />
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
                                    ...
                                    <img id="previewlist" src="" alt="List Image" height="100" width="100" class="mb-1" style="display:none;">
                                </div>
                                ...
                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
                                    ...
                                    <img id="previewdetail" src="" alt="Detail Image" height="100" width="100" class="mb-1" style="display:none;">
                                </div>
                                <div class="col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        <label class="form-label" for="list_description">Service Description(List)<span class="text-danger">*</span></label>
                                        <textarea class="form-control" id="list_description" name="list_description" rows="4" placeholder="Please Enter Service Description"></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        <label class="form-label" for="detail_description">Service Description(Detail)<span class="text-danger">*</span></label>
                                        <textarea class="form-control ckeditor" id="detail_description" name="detail_description" rows="4" placeholder="Please Enter Service Description"></textarea>
                                    </div>
                                </div>
