        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div class="page-leftheader">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a>Edit Email</a></li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" id="emailForm" name="emailForm" action="{{route('updateemail')}}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="emailTemplateId" value="{{base64_encode($email->id)}}">
                            <div class="row gy-4">
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                    <label for="subject" class="form-label">Email Subject<span class="text-danger">*</span></label>
                                    <input type="text" name="subject" class="form-control" id="subject" maxlength="750" value="{{ $email->subject }}" placeholder="Please Enter Email Subject">
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    <label for="editor" class="form-label">Content<span class="text-danger">*</span></label>
<!--                                    <div id="editor" style="height: 200px; overflow-y: auto; border: 1px solid #ced4da; padding: 10px;">{!! $email->content !!}</div>
                                    <input type="hidden" name="content" id="content">-->
                                    <textarea class="form-control ckeditor" id="content" maxlength="5000" name="content">{{ $email->content }}</textarea>
                                </div>
    ...
    $("#emailForm").validate({
        ...
        messages: {
            title: {
                ...
                minlength: "Email title should be minimum {0} characters",
                maxlength: "Email title should be maximum {0} characters"
            },
            subject: {
