        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" id="faqaddform" name="profile_form" action="{{route('updatetag')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title" value="{{ $tag->name }}" placeholder="Please Enter Title" />
                                    </div>
                                </div>
