<div class="modal-header">
    <h6 class="modal-title" id="staticBackdropLabel">Delete Success Stories
    </h6>
...
<form id="edit_setting_form" name="edit_setting_form">
    ...
    <div class="modal-body">
        <p>Are you sure you want to delete this success stories?</p>
    </div>
...
<script>
    ...
    function deteleSetting() {
        ...
        $.ajax({
            url: admin_path + 'deletesuccessstories',
            method: 'post',
            data: {
