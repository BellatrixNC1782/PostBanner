        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div class="page-leftheader">
                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a>Success Stories Management</a></li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="text-end">
                            <a class="" href="{{route('addsuccessstories')}}">
                                <button type="button" class="btn btn-primary">Add Success Stories</button>
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
...
<script>
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        ...
                        var id = row.id;
                        if (status == 'active') {
                            return '<button title="Active" class="btn btn-success waves-effect waves-light" onClick="successStoriesStatusChange(' + id + ')">Active</button>';
                        } else {
                            return '<button title="Deactive" class="btn btn-danger waves-effect waves-light" onClick="successStoriesStatusChange(' + id + ')">Deactive</button>';
                        }
                    }
                },
                {
                    ...
                    "render": function(data, type, row) {
                        ...
                        out += '<a title="Edit Success Stories" class="text-info fs-14 lh-1" href="{{url("admincp/editsuccessstories")}}/' + id + '" ><i class="ri-edit-line"></i></a>&nbsp;&nbsp;&nbsp;';
                        out += '<a title="Delete Success Stories" class="text-danger fs-14 lh-1" onClick="deleteSuccessStories(' + id + ');"><i class="ri-delete-bin-5-line"></i></a>';
                        return out;
                    }
                },
            ]
    ...
    function deleteSuccessStories(id) {
        $.ajax({
            url: admin_path + 'successstoriesdeletemodal/' + id,
    ...
    function successStoriesStatusChange(id) {
        $.ajax({
            url: admin_path + 'changesuccessstoriesstatusmodal/' + id,
            success: function(response) {
                if (response.status == 'success') {
