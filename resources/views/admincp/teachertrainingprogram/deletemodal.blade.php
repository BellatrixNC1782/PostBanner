<div class="modal-header">
    <h6 class="modal-title" id="staticBackdropLabel">Delete Teacher Traing Program
    </h6>
...
<form id="edit_setting_form" name="edit_setting_form">
    ...
    <div class="modal-body">
        <p>Are you sure you want to delete this teacher training program?</p>
    </div>
...
<script>
    ...
    function deteleSetting() {
        ...
        $.ajax({
            url: admin_path + 'deleteteachertrainingprogram',
            method: 'post',
            data: {
