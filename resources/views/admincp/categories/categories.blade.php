        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div class="page-leftheader">
                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a>Category Management</a></li>
                </ol>
            </div>
        </div>
...
<script>
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        ...
                        var id = row.id;
                        if (status == 'active') {
                            return '<button title="Active" class="btn btn-success waves-effect waves-light" onClick="categoryStatusChange(' + id + ')">Active</button>';
                        } else {
                            return '<button title="Deactive" class="btn btn-danger waves-effect waves-light" onClick="categoryStatusChange(' + id + ')">Deactive</button>';
                        }
                    }
                },
                {
                    ...
                    "render": function(data, type, row) {
                        ...
                        out += '<a title="Edit Category" class="text-info fs-14 lh-1" href="{{url("admincp/editcategory")}}/' + id + '" ><i class="ri-edit-line"></i></a>&nbsp;&nbsp;&nbsp;';
                        out += '<a title="Delete Category" class="text-danger fs-14 lh-1" onClick="deleteCategory(' + id + ');"><i class="ri-delete-bin-5-line"></i></a>';
                        return out;
                    }
                },
            ]
    ...
    function deleteCategory(id) {
        $.ajax({
            url: admin_path + 'categorydeletemodal/' + id,
    ...
    function categoryStatusChange(id) {
        $.ajax({
            url: admin_path + 'changecategorystatusmodal/' + id,
            success: function(response) {
                if (response.status == 'success') {
