        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div class="page-leftheader">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="{{ route('categories') }}">Category</a></li>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" id="faqaddform" name="profile_form" action="{{route('updatecategory')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title" value="{{ $category->title }}" placeholder="Please Enter Title" />
                                    </div>
                                </div>
