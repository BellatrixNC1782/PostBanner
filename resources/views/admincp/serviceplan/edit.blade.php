        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" id="faqaddform" name="profile_form" action="{{route('updateserviceplan')}}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="service_plan_id" value="{{ $service_plan->id }}">
                            <div class="row">
                                <div class="col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="service_id" name="service_id">
                                            ...
                                            <option {{ ($service_plan->service_id == $service->id) ? "selected" : "" }} value="{{ $service->id }}">{{ $service->name }}</option>
                                            @endforeach()
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" value="{{ $service_plan->name }}" placeholder="Please Enter Plan Name" />
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="duration_type" name="duration_type">
                                            <option {{ ($service_plan->duration_type == "month") ? "selected" : "" }} value="month">Month</option>
                                            <option {{ ($service_plan->duration_type == "year") ? "selected" : "" }} value="year">Year</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" step="1" oninput="this.value = this.value.replace(/[^0-9]/g, '')" class="form-control" id="amount" name="amount" value="{{ $service_plan->amount }}" placeholder="Please Enter Amount" />
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
                                    ...
                                    <img id="previewimage" src="{{ $service_plan->image }}" alt="Image" height="100" width="100" class="mb-1">
                                </div>
