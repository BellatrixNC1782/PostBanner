        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" id="faqaddform" name="profile_form" action="{{route('updateblogs')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="category_id" id="category_id">
                                            ...
                                            <option value="{{ $category->id }}" {{ ($blogs->category_id == $category->id) ? "selected" : "" }}>{{ $category->name }}</option>
                                            @endforeach()
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title" value="{{ $blogs->title }}" placeholder="Please Enter Title" />
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="tags_ids[]" id="tags_ids" multiple>
                                            ...
                                            <option value="{{ $tag->id }}" {{ (in_array($tag->id, $blog_tag_array)) ? "selected" : "" }}>{{ $tag->name }}</option>
                                            @endforeach()
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control ckeditor" id="description" name="description" placeholder="Please Enter Description">{{ $blogs->description }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2 col-sm-2">
                                    ...
                                    <img id="previewimage" src="{{ $blogs->image }}" alt="Image" height="100" width="100" class="mb-1">
                                </div>
