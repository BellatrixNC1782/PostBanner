(function () {
    ...
    var options = {
        ...
        colors: ["#705ec8", "#fb1c52", "#ffaa00", "#ef4d4d"],
        responsive: [{
            breakpoint: 480,
            options: {
                legend: {
    ...
    var colors = ['#705ec8', '#fb1c52', '#ffaa00', '#5c7fff', '#ef4d4d', '#38cc89', '#5b67c7'];
    ...
    var options = {
        ...
        colors: ['#705ec8', '#fb1c52', '#ffaa00', '#5c7fff', '#ef4d4d', '#38cc89', '#5b67c7', '#a65e76'],
        plotOptions: {
            bar: {
                columnWidth: '45%',
                distributed: true,
