(function () {
    ...
    const data = {
        ...
        datasets: [{
            ...
            backgroundColor: 'rgb(112, 94, 200)',
            borderColor: 'rgb(112, 94, 200)',
    ...
    const data6 = {
        ...
        datasets: [{
            ...
            backgroundColor: 'rgba(132, 90, 223, 0.2)',
            borderColor: 'rgb(112, 94, 200)',
            pointBackgroundColor: 'rgb(112, 94, 200)',
            pointBorderColor: '#fff',
            pointHoverBackgroundColor: '#fff',
            pointHoverBorderColor: 'rgb(112, 94, 200)'
        }, {
            label: 'My Second Dataset',
            data: [28, 48, 40, 19, 96, 27, 100],
            fill: true,
            backgroundColor: 'rgba(251, 28, 82, 0.2)',
            borderColor: 'rgb(251, 28, 82)',
            pointBackgroundColor: 'rgb(251, 28, 82)',
            pointBorderColor: '#fff',
            pointHoverBackgroundColor: '#fff',
            pointHoverBorderColor: 'rgb(251, 28, 82)'
        }]
    };
    const config7 = {
        type: 'radar',
